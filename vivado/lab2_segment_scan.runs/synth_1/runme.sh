...
HD_PWD='C:/Users/gaeun/Desktop/lab2_08_segment_scan/vivado/lab2_segment_scan.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab2_segment_scan.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab2_segment_scan.tcl
