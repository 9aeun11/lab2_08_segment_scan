...
HD_PWD='C:/Users/gaeun/Desktop/lab2_08_segment_scan/vivado/lab2_segment_scan.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab2_segment_scan.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab2_segment_scan.tcl -notrace
